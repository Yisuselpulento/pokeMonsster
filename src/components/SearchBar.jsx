  ...
  return (
    <form className="max-w-md mx-auto my-3">   
      ...
      <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm  border border-gray-300 rounded-lg bg-neutral-800 focus:ring-blue-900 focus:border-blue-900" placeholder="Buscar Pokemon" required />
      </div>
    </form>
  )
}
